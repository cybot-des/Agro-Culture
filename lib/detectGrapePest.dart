import 'package:farmsecure/GrapeBlackMeasles.dart';
import 'package:farmsecure/GrapeBlackRot.dart';
import 'package:farmsecure/GrapeBlight.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:tflite/tflite.dart';
import 'package:image_picker/image_picker.dart';

class DetectGrapePest extends StatefulWidget {
  @override
  _DetectGrapePestState createState() => _DetectGrapePestState();
}

class _DetectGrapePestState extends State<DetectGrapePest> {
  File _image;
  List _results;
  int ctr=1;
  @override
                                    ...
                                    children: _results != null
                                      ...
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: Colors.white,
                                          boxShadow: [
                                            BoxShadow(color:Color(0xFFC0CA33), spreadRadius: 2),
                                          ],
                                        ),
                                        child: GestureDetector(child:Container(
                                          ...
                                          onTap: (){
                                            ...
                                            {
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => GrapeBlackMeasles()));
                                            }
                                            else if (result["index"]==3)
                                            {
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => GrapeBlight()));
  ...
  Future loadModel() async {
    ...
    res = await Tflite.loadModel(
      model: "assets/Grape_Model/Grape_model_unquant.tflite",
      labels: "assets/Grape_Model/Grape_labels.txt",
    );
    print(res);
  }
