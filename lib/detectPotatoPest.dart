import 'package:farmsecure/PotatoEarlyBlight.dart';
import 'package:farmsecure/PotatoLateBlight.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:tflite/tflite.dart';
import 'package:image_picker/image_picker.dart';

class DetectPotatoPest extends StatefulWidget {
  @override
  _DetectPotatoPestState createState() => _DetectPotatoPestState();
}

class _DetectPotatoPestState extends State<DetectPotatoPest> {
    File _image;
    List _results;
    int ctr=1;
    @override
  ...
  Widget build(BuildContext context) {
                                    ...
                                    children: _results != null
                                      ...
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: Colors.white,
                                          boxShadow: [
                                            BoxShadow(color:Color(0xFF3E2723), spreadRadius: 2),
                                          ],
                                        ),
                                      ...
                                      child:Container(
                                          ...
                                          onTap: (){
                                            ...
                                            {
                                              //print("yes");
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => PotatoEarlyBlight()));
                                            }
    ...
    Future loadModel() async {
      ...
      res = await Tflite.loadModel(
        model: "assets/Potato_Model/Potato_model_unquant.tflite",
        labels: "assets/Potato_Model/Potato_labels.txt",
      );
      print(res);
    }
