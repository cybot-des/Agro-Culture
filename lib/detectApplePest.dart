import 'package:farmsecure/AppleBlackRot.dart';
import 'package:farmsecure/AppleCedarRust.dart';
import 'package:farmsecure/AppleScab.dart';
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:tflite/tflite.dart';
import 'package:image_picker/image_picker.dart';

class DetectApplePest extends StatefulWidget {
  @override
  _DetectApplePestState createState() => _DetectApplePestState();
}

class _DetectApplePestState extends State<DetectApplePest> {
  File _image;
  List _results;
  int ctr=1;
  @override
                                      ...
                                      return Container(
                                        ...
                                        child: GestureDetector(child:Container(
                                          ...
                                          onTap: (){
                                            ...
                                            {
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => AppleBlackRot()));
                                            }
  ...
  Future loadModel() async {
    ...
    res = await Tflite.loadModel(
      model: "assets/Apple_Model/Apple_model_unquant.tflite",
      labels: "assets/Apple_Model/Apple_labels.txt",
    );
    print(res);
  }
