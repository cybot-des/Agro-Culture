                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child:ListView(
                        ...
                        children: [
                          //*************************1st container****************************************
                          Image(image:AssetImage('assets/Corn_Model/common_rust.jpg'),height: 250,width: 250, ),
                          SizedBox(height: 20,),
                          Text("Symptoms:\n",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                          Text('Common rust is caused by the fungus Puccinia sorghi. Late occurring infections '
                              ...
                              'Symptoms of common rust often appear after silking.Small, round to elongate brown'
                              ' pustules form on both leaf surfaces and other above ground parts of the plant.'
                              'As the pustules mature they become brown to black.If disease is severe, the leaves '
                              'may yellow and die early.\n\n',
                          ...
                          Text('The use of resistant hybrids is the primary management strategy for the control '
                              'of common rust.Timely planting of corn early during the growing season may help '
                              'to avoid high inoculum levels or environmental conditions that would promote '
                              'disease development.',
                            style: TextStyle(fontSize: 18),
                          )
